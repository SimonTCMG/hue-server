...
*Master brief for all Claude sessions. Last updated: 20 April 2026 (Team sticky headers, share tokens, weekly check-in system — DB, API, cron, frontend; header consistency pass — Results pattern applied to team dashboard, org admin, shared team).*
